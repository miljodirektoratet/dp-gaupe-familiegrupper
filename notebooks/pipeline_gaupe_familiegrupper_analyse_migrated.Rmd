...
# Load migrated package functions (order_observations, create_time_matrix, create_distance_matrix, 
# create_centerpoints, create_lines, apply_distance_rules)
devtools::load_all(file.path(base_path))

# Source functions not yet migrated to package
# These are needed by grouplynx() and grouplynx_diff_starts()
source(file.path(base_path, "staging/Functions/Function_CreateOldDistanceRules.R"))
source(file.path(base_path, "staging/Functions/Function_HierarcichalClustering.R"))
source(file.path(base_path, "staging/Functions/Function_CustomClustering.R"))
source(file.path(base_path, "staging/Functions/Function_SplitGroups.R"))
source(file.path(base_path, "staging/Functions/Function_PrettyLines.R"))
...
cat("Best hierarchical:", fam_groups$sorting[best_hclust_idx], 
...
cat("Best custom:", fam_groups$sorting[best_custom_idx],
